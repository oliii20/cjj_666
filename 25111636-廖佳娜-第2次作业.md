...
## **解题思路**
- 计算 merkle proof 即从底向上两两相加计算哈希，这里采用**一层 SHA-256 哈希算法**，最终得到 最上层哈希根；
- **验证 叶子节点 sysu**，即层层得到该叶子节点及其兄弟节点的哈希值，向上索引计算得到 merkle proof，与原 merklr proof 进行比较即可，若相等则该数据存在。
...
## **实验结果如下：**
- ![这是图片](/validation_result.png "反射类型转换图")
